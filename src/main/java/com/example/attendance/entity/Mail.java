...
public class Mail {
	...
	// gmail金鑰
	private static String pwd = "zokw srlf plbt wezh";
...
//	}
	...
	public static void sentSignUpMail(String email) {
		...
		// 寄件人
		String senderName = "皮皮蝦購物";
		String senderEmail = "qtp0110416@gmail.com";
		...
		try {
			...
			// 設定信件內容
			message.setText("你成為了皮皮蝦購物會員，皮皮蝦購物你的加入");
	...
	public static void sentLoginMail(String email) {
		...
		// 寄件人
		String senderName = "皮皮蝦購物負責人";
		String senderEmail = "qtp0110416@gmail.com";
		String senderPassword = "zokw srlf plbt wezh";
	...
	public static void sentForgotPwdMail(String email, String cachedRandomPwd) {
		...
		try {
			...
			String emailContent = "這是您的一次性密碼 : " + cachedRandomPwd + "請先使用一次性密碼登入後再更改密碼，謝謝。"
					+ "在更改密碼頁面時驗證碼欄位即為您收到的一次性密碼，" + "皮皮蝦股份有限公司祝您身體健康。";
	...
	public static void sentChangePwdMail(String email) {
		...
		try {
			...
			// 設定信件內容
			message.setText("謝謝您，皮皮蝦有限公司歡迎您的回歸。");
	...
	// 確認是否儲值點數使用
	public static void sentConfirmMail(String email, String verCode) {
		...
		try {
			...
			// 設定信件主題
			message.setSubject("儲值點數驗證碼");

			// 設定信件內容
			message.setText("您的點數序號為:" + verCode);
